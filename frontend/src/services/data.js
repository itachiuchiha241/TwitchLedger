import kokohaanAvatar from "../assets/kokohaan.png";
...
export const channels = [
  {
    ...
    role: "VTuber",
    description: "Konnichiwa! I'm a Japanese Apprentice Witch🧙‍♀️💫 I'm learning English through all kinds of games🎀I aim to create a win-win stream where English speakers who want to learn Japanese and I can learn together✨ ※All archives are available on Youtube.",
  },
  {
    name: "がぶ飲みちゃん",
    subs: 4150,
    ...
    role: "VTuber",
    description: "がぶちゃんと申します😊醤油をがぶ飲みしていたら色黒になりました🙏平日22:30～配信中！⋆͛🎮⋆͛ I'm Gabu-chan! I have chugged soy sauce a lot🙋‍♀️♡Genshin impact/Honkai starrail / Resindet evil / SF6♡",
  },
  {
    name: "我妻まや",
    subs: 1436,
    ...
    role: "VTuber",
    description: "流星街育ちの未亡人です～！あがつままやなので、略してママって呼んでね❤みんなを優しく包んで絞めあげます❤※AIイラスト使用してるorしたことある配信者さんはごめんなさい。先手ブロックしてることもあります。",
  },
  {
    name: "れんれんだよぉ",
    subs: 297,
    ...
    role: "VTuber",
    description: "※全てのゲームが下手 / 不定期で配信(日中〜夕方が多め) / スタンプいっぱいあるから使ってね♡ / ※AIイラストを使用している方はブロックしていることがあります",
  },
  {
    name: "ちさと_",
    subs: 281,
